...
if ( $max_value && $min_value === $max_value ) {
    ...
    $label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'cirkle' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'cirkle' );
    ?>
    <div class="quantity">
        ...
        <input
            ...
            title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'cirkle' ); ?>"
