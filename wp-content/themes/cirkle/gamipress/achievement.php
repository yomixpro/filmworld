...
$cols = '';
$ubc = cmb2_get_option('gamipress_settings', 'bp_members_achievements_columns');
...
$classes = array(
    ...
    'cirkle-user-badges col-xl-'.$cols.' col-md-4 col-sm-6'
);
                ...
                <div class="gamipress-achievement-attached">
                    ...
                    <?php if ( $a['toggle'] === 'yes' ) : ?>
                        ...
                        <div id="show-more-<?php the_ID(); ?>" class="gamipress-open-close-switch">
                            <a class="show-hide-open" data-achievement-id="<?php the_ID(); ?>" data-action="open" data-open-text="<?php esc_attr_e( 'Show Details', 'cirkle' ); ?>" data-close-text="<?php esc_attr_e( 'Hide Details', 'cirkle' ); ?>" href="#"><?php esc_html_e( 'Show Details', 'cirkle' ); ?></a>
                        </div>
