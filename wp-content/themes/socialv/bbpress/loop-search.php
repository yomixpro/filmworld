...
<ul id="bbp-search-results" class="forums bbp-search-results">
	...
	<li class="bbp-header">
		...
		<div class="bbp-search-author"><?php esc_html_e( 'Author',  'socialv' ); ?></div><!-- .bbp-reply-author -->

		<div class="bbp-search-content">

			<?php esc_html_e( 'Search Results', 'socialv' ); ?>
	...
	<li class="bbp-footer">
		...
		<div class="bbp-search-author"><?php esc_html_e( 'Author',  'socialv' ); ?></div>
