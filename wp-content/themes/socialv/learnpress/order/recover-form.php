...
<div class="order-recover">
	<input type="text" name="order-key" value="<?php echo esc_attr( $order_key ); ?>" placeholder="<?php esc_attr_e( 'Order key', 'socialv' ); ?>">
	...
	<button type="button" class="socialv-button button-recover-order"><?php esc_html_e( 'Recover', 'socialv' ); ?></button>
</div>
