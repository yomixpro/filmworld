...
<?php else : ?>
	...
	<form method="post" name="learn-press-form-complete-lesson"
		...
		data-title="<?php echo esc_attr__( 'Complete lesson', 'socialv' ); ?>"
		...
		<button class="button button-complete-item button-complete-lesson lp-btn-complete-item btn socialv-btn-success">
			<?php echo esc_html__( 'Complete', 'socialv' ); ?>
		</button>
