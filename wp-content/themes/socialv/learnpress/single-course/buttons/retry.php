...
$message_data_confirm = sprintf(
	'%s "%s"',
	esc_html__( 'Do you want to retake course', 'socialv' ),
	$course->get_title()
);
?>
...
<form name="lp-form-retake-course" class="lp-form-retake-course" method="post" enctype="multipart/form-data"
	...
	<button class="button button-retake-course socialv-button">
		<?php echo sprintf( '%s (%d)', esc_html__( 'Retake course', 'socialv' ), $can_retake_times ); ?>
	</button>
