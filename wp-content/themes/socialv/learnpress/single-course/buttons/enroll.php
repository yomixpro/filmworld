...
<form name="enroll-course" class="enroll-course" method="post" enctype="multipart/form-data">
	...
	<button class="button button-enroll-course socialv-button">
		<?php echo esc_html( apply_filters( 'learn-press/enroll-course-button-text', esc_html__( 'Start Now', 'socialv' ) ) ); ?>
	</button>
