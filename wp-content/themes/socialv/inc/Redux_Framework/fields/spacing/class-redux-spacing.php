	...
	class Redux_Spacing extends Redux_Field {
		...
		public function render() {
			...
			if ( true === $this->field['all'] ) {
				...
				echo '<div class="field-spacing-input input-prepend">
                        ...
                        <input
                            ...
                            placeholder="' . esc_html__( 'All', 'socialv' ) . '"
				...
				if ( true === $this->field['top'] ) {
					echo '<div class="field-spacing-input input-prepend">';
                        ...
                        echo '<input type="text"
                                   ...
                                   placeholder="' . esc_html__( 'Top', 'socialv' ) . '"
				...
				if ( true === $this->field['bottom'] ) {
					echo '<div class="field-spacing-input input-prepend">';
                            ...
                            echo '<input type="text"
                                   ...
                                   placeholder="' . esc_html__( 'Bottom', 'socialv' ) . '"
				...
				if ( true === $this->field['right'] ) {
					echo '<div class="field-spacing-input input-prepend">';
                            ...
                            echo '<input type="text"
                                   ...
                                   placeholder="' . esc_html__( 'Right', 'socialv' ) . '"
				...
				if ( true === $this->field['left'] ) {
					echo '<div class="field-spacing-input input-prepend">';
                            ...
                            echo '<input type="text"
                                   ...
                                   placeholder="' . esc_html__( 'Left', 'socialv' ) . '"
			...
			if ( false !== $this->field['units'] && true === $this->field['display_units'] ) {
				echo '<div class="select_wrapper spacing-units" original-title="' . esc_html__( 'Units', 'socialv' ) . '">';
				...
				echo '<select data-placeholder="' . esc_html__( 'Units', 'socialv' ) . '" class="redux-spacing redux-spacing-units select ' . esc_attr( $this->field['class'] ) . '" original-title="' . esc_html__( 'Units', 'socialv' ) . '" id="' . esc_attr( $this->field['id'] ) . '_units"' . esc_attr( $select2_data ) . '>';
