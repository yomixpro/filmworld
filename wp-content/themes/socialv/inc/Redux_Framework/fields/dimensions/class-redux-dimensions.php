		...
		public function render() {
			...
			if ( true === $this->field['width'] ) {
				...
				echo '<input
						...
						placeholder="' . esc_html__( 'Width', 'socialv' ) . '"
			...
			if ( true === $this->field['height'] ) {
				...
				echo '<input
						...
						placeholder="' . esc_html__( 'Height', 'socialv' ) . '"
			...
			if ( isset( $this->field['units'] ) && false !== $this->field['units'] ) {
				echo '<div
						...
						original-title="' . esc_html__( 'Units', 'socialv' ) . '">';
				...
				echo '<select
						data-id="' . esc_attr( $this->field['id'] ) . '"
						data-placeholder="' . esc_html__( 'Units', 'socialv' ) . '"
