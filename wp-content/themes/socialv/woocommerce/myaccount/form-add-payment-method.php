	...
	<form id="add_payment_method" method="post">
		<div id="payment" class="woocommerce-Payment">
			...
			<div class="form-row p-0 mb-0">
				...
				<button type="submit" class="woocommerce-Button woocommerce-Button--alt alt socialv-button btn btn-hover<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" id="place_order" value="<?php esc_attr_e( 'Add payment method', 'socialv' ); ?>">
					<?php esc_html_e( 'Add payment method', 'socialv' ); ?>					
				</button>
...
<?php else : ?>
	<p class="woocommerce-notice woocommerce-notice--info woocommerce-info"><?php esc_html_e( 'New payment methods can only be added during checkout. Please contact us if you require assistance.', 'socialv' ); ?></p>
<?php endif; ?>
