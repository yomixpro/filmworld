...
if ( ! class_exists( 'Wbcom_Admin_Settings' ) ) {
	...
	class Wbcom_Admin_Settings {
		...
		public function wbcom_enqueue_admin_scripts() {
			...
			if ( ! wp_script_is( 'wbcom_admin_setting_js', 'enqueued' ) ) {
				...
				wp_register_script(
					...
					BPXP_PLUGIN_URL . 'admin/wbcom/assets/js/wbcom-admin-setting.js',
					array( 'jquery' ),
					time(),
					false
				);
		...
		public function wbcom_admin_additional_pages() {
			add_submenu_page(
				'wbcomplugins',
				esc_html__( 'Our Plugins', 'bp-xprofile-export-import' ),
				esc_html__( 'Our Plugins', 'bp-xprofile-export-import' ),
				'manage_options',
				'wbcom-plugins-page',
			...
			add_submenu_page(
				'wbcomplugins',
				esc_html__( 'Our Themes', 'bp-xprofile-export-import' ),
				esc_html__( 'Our Themes', 'bp-xprofile-export-import' ),
				'manage_options',
				'wbcom-themes-page',
			...
			add_submenu_page(
				'wbcomplugins',
				esc_html__( 'Support', 'bp-xprofile-export-import' ),
				esc_html__( 'Support', 'bp-xprofile-export-import' ),
				'manage_options',
				'wbcom-support-page',
					...
					<ul>
						...
						<li class="wb_admin_nav_item <?php echo esc_attr( $plugin_active ); ?>">
							<a href="<?php echo esc_url( get_admin_url() ) . 'admin.php?page=wbcom-plugins-page'; ?>" id="wb_admin_nav_trigger_extensions">
								...
								<h4><?php esc_html_e( 'Themes & Extension', 'bp-xprofile-export-import' ); ?></h4>
							</a>
						</li>
						<li class="wb_admin_nav_item <?php echo esc_attr( $support_active ); ?>">
							<a href="<?php echo esc_url( get_admin_url() ) . 'admin.php?page=wbcom-support-page'; ?>" id="wb_admin_nav_trigger_support">
								...
								<h4><?php esc_html_e( 'Help & Support', 'bp-xprofile-export-import' ); ?></h4>
							</a>
						</li>
