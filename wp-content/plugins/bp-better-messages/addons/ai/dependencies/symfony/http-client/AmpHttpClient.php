...
use BetterMessages\Symfony\Component\HttpClient\Internal\AmpClientState;
use BetterMessages\Symfony\Component\HttpClient\Response\AmpResponse;
...
if (!interface_exists(Promise::class)) {
    throw new \LogicException('You cannot use "BetterMessages\Symfony\Component\HttpClient\AmpHttpClient" as the installed "amphp/http-client" is not compatible with this version of "symfony/http-client". Try downgrading "amphp/http-client" to "^4.2.1".');
}
